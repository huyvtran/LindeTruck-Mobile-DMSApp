...
echo '\x1B[0;94mPreparing Project for iOS Development\x1B[0m'
echo '\x1B[0;94m**********************************************************\x1B[0m'
...
cordova plugin add phonegap-plugin-push@1.8.4  --nofetch --nosave --variable SENDER_ID='com.capgemini.linde.avanto' >/dev/null 2>/dev/null

echo '\x1B[0;90m✓ Installing wkwebviewxhrfix plugin\x1B[0m'
cordova plugin add https://github.com/TheMattRay/cordova-plugin-wkwebviewxhrfix.git --nofetch --nosave >/dev/null 2>/dev/null

echo '\x1B[0;32m✓ Adding iOS platform to project.\x1B[0m'
cordova platform add ios@4.5.4 --nofetch --nosave
...
#ionic resources >/dev/null 2>/dev/null

echo '\x1B[0;32m✓ Prepare platform.\x1B[0m'
cordova prepare ios >/dev/null 2>/dev/null
