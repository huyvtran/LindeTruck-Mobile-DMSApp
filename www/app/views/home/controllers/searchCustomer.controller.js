angular.module('oinio.SearchCustomerController', [])
  .controller('SearchCustomerController', function ($scope, $rootScope, $ionicPopup, $filter, $log, $state, $stateParams, AppUtilService, ForceClientService, LocalCacheService) {
