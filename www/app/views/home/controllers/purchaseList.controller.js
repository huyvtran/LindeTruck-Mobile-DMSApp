angular.module('oinio.PurchaseListController', [])
  .controller('PurchaseListController', function ($scope, $rootScope, $ionicPopup, $filter, $log, $state, $stateParams,  ForceClientService, AppUtilService, Service1Service, LocalCacheService) {
