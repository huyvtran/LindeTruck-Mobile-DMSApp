angular.module('oinio.SearchVehicleController', [])
  .controller('SearchVehicleController', function ($scope, $rootScope, $ionicPopup, $filter, $log, $state, $stateParams, AppUtilService, ForceClientService, LocalCacheService) {
