...
angular
  ...
  .service('TimeCardService',
    function ($q, $http, $interval, $ionicPopup, $ionicLoading, $cordovaFileTransfer, $cordovaFileOpener2, LocalSyncService, ForceClientService) {
      ...
      function showUpdateConfirm(version) {
        ...
        confirmPopup.then(function (res) {
          if (res) {
            ...
            var url = 'http://139.219.108.57:98/seapp.zip'; //可以从服务端获取更新APP的路径
