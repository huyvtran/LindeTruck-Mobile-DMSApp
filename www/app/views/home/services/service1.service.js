        ...
        .service('Service1Service', function($q, $log, $filter,LocalDataService,SMARTSTORE_COMMON_SETTING,
            ...
            this.searchAccounts = function(keyword,isOnline){
                if(isOnline){
                    ...
                    let str_fields = 'id,Name,Customer_Number__c,Address__c,SAP_Number__c,Office_Address__c,Service_Group_Rental2__c,Division__c,Service_Remarks__c,ServiceIsFrozen__c,RentalServiceIsFrozen__c';
