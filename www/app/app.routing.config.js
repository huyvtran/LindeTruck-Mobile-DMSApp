    ...
    function routing($stateProvider, $urlRouterProvider,$ionicConfigProvider) {
        ...
        $stateProvider
            ...
            .state('app.newOfferFittings', {
                ...
                params:{'SendAllUser':null,'SendSoupEntryId':null,'OrderTruckItem':null,'SubjectC':null,'Contact__c':null,'Division__c':null},
                views: {
                    menuContent: {
          ...
          .state('app.deliveryList', {
            ...
            .state('app.workDetails', {
                url: 'app/workDetails',
                params:{'SendInfo':null,'workDescription':null,'AccountShipToC':null,'goOffTime':null,'isNewWorkList':null,'selectWorkTypeIndex':null,'workOrderId':null,'enableArrivalBtn':null,"accountId":null,'orderBelong':null,'openPrintPage':null},
                views: {
                    menuContent: {
          ...
          .state('app.refundDetail', {
            ...
            .state('app.generateOrders', {
                url: '/generateOrders',
                params:{'workOrderId':null,'accountId':null,'WorkOrderType':null},
                views: {
                    menuContent: {
